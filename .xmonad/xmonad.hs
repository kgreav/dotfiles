...
myFocusColor :: String
myFocusColor  = "#d08770"  -- Border color of focused windows
...
myWorkspaces = ["1:slack", "2:dev", "3:ff", "4:brave", "5:dev", "6:dev", "7:ff", "8:ff", "9:mail"]
...
myManageHook = composeAll
     ...
     [ title =? "Mozilla Firefox"     --> doShift ( myWorkspaces !! 2 ) -- Move firefox to space 3
...
myKeys home =
    ...
    -- Run Prompt
        ...
        , ("M-S-<Return>", spawn "rofi -i -show drun -config ~/.config/rofi/config.rasi -p \"Run: \"") -- Rofi
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = workspaceHistoryHook <+> myLogHook <+> dynamicLogWithPP xmobarPP
                        ...
                        , ppCurrent = xmobarColor "#1fffef" ""                -- Current workspace in xmobar
                        , ppVisible = xmobarColor "#e5e9f0" ""                -- Visible but not current workspace
                        , ppHidden = xmobarColor "#82AAFF" ""                 -- Hidden workspaces in xmobar
                        , ppHiddenNoWindows = xmobarColor "#e5e9f0" ""        -- Hidden workspaces (no windows)
                        , ppTitle = xmobarColor "#e5e9f0" "" . shorten 60     -- Title of active window in xmobar
